...
from llms_from_scratch.models.gpt2 import GPT_CONFIG, TRAIN_SETTINGS, GPTModel
...
def create_loaders(text_data, tokenizer):
    train_ratio = 0.90
...
def save_loss_plot(train_losses, val_losses, tokens_seen):
...
def main():
    ...
    train_loader, val_loader = create_loaders(text_data, tokenizer)
    ...
    save_loss_plot(train_losses, val_losses, tokens_seen)
